...
**Open-Core v1 feature loop is SHIPPED** (GF-0 → GF-9). `GF-<n>` is the feature-track
prefix — **GF** = **G**ra**F**ture (formerly `SS-<n>`, from the old name Schema Studio);
renamed with the project, numbers unchanged. Clone → `pnpm dev` → upload files →
...
| Epic                          | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Core engine (GF-0/1/2)        | ✅ model, action protocol, parsers (incl. even-spread row sampling, null-token handling, `timestamp` type)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Web foundation (GF-3/4/5)     | ✅ store, canvas, sources panel                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Ingestion + AI (GF-6)         | ✅ copilot + agentic loop + BYO key; `preview_export` agentic tool (on `main`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Round-trip (GF-7/8)           | ✅ exporters (DBML/SQL/Prisma) + local persistence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Modeling intelligence (GF-9)  | ✅ detectors, copilot-fed — the list rots; source of truth is the exports of `packages/core/src/detect/index.ts` (8 as of 2026-07-05: join, format, grain, PK, semantic-type, value-set, composite-key, functional-dependency)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Copilot agency upgrade        | ✅ **implemented on `chore/rebrand-grafture` (2026-07-11, per `copilot-agency-upgrade-plan.md` PR-0…PR-5)**: wide join-discovery pass (`SourceField.joinValues`, `MAX_JOIN_VALUES=100k`, stripped on BOTH persistence writes — in-memory only, reload degrades to the 1000-value window); **JSON array-of-objects unnesting** — `parseJson`/`parseSource` now return `Source[]` (parent + child sources with synthetic `_rowId`/`_parentId` surrogates excluded from all detectors, lineage on `Source.derivedFrom`, `addSources` store command = one undo step); **containment-aware `detectJoinKeys`** (`containmentLeft/Right` on `JoinKeyCandidate`, τ=0.4 gate with a >12-distinct floor on the contained side, candidates ranked by max(jaccard, containment)); **`probe_join` agentic tool** (core `probeJoin()` + `copilot/probeJoinTool.ts`, registered at both loop sites); **investigation phase** (`MAX_PREVIEW_ITERATIONS=6`; submit withheld for first 2 rounds of a fresh derivation with sources — both `AnthropicBrowserProvider` and `openaiCompatible`); **N:M junction scaffolding** in `buildApplyPlan` + child-FK in `buildTableFromSource` + prompt doctrine (junction emission, `derived_from` lineage rendering). §6 fixtures checked in: `packages/core/test/fixtures/hrsa_mini.csv` (200 rows) + `opais_mini.json` (150 records), acceptance suite `test/hrsaOpais.test.ts`, boundary fixture in `detect.test.ts`. Residual: real-file NPI-bridge smoke against `local-data/` is a manual check (no committable 93k-row fixture). |
...
| **Launch packaging (GF-10)**  | 🟨 **T5 (static deploy) + T6 (demo clip) are the remaining gap** — T1–T4 landed (PR #12; verify by artifact: `ls .github/workflows/ci.yml CONTRIBUTING.md apps/web/public/demo/`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
### P0 — Launch packaging (GF-10) · owner: _unassigned_
...
- **Don't both edit the store/canvas spine in the same window.** Suggested split:
  - **Owner A → launch track:** T5/T6 (the open remainder of GF-10) + T8 QA. Repo-root /
